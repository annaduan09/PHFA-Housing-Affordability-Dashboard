...
ui <- navbarPage(theme = bs_theme(bootswatch = "yeti"),
        ...
        tabPanel("Interactive map", sidebarLayout(
          sidebarPanel(width = 3, h3("Affordable Housing Explorer"), 
                       selectInput("variable", "Select a variable", choices = list("Homeowners" = list("Homeownership rate (%)" = "owner_occ_hh_pct2021",
                       ...
                       p("blabklmigniopengpierngpirngpirenfpienfhpienfpiefnepinfepifnrpinfiorcnpimdepocmkpofmfpigefpiien"),
